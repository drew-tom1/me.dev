  ...
  return (
    <section>
      ...
      <p className="my-4">
        ...
        <a href="https://sce.sjsu.edu/" target="_blank" rel="noopener noreferrer" className="hover:scale-105 text-red-400 dark:text-cyan-200">Software and Computer Engineering Society</a>
